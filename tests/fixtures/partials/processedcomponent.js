...
class standardCardComponent extends BaseCard['standard'] {
  ...
  dataForRender(profile) {
    return {
      ...
      details: ANSWERS.translateJS('{"0":"Un article [[name]]","plural":"Les articles [[name]]","locale":"fr-FR"}', {name:profile.name,count:profile.count}, profile.count), // The text in the body of the card
      showMoreDetails: {
